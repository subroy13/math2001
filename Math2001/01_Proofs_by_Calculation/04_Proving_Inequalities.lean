...
example {n : ℤ} (hn : n ≥ 10) : n ^ 4 - 2 * n ^ 2 > 3 * n ^ 3 :=
  calc
    n ^ 4 - 2 * n ^ 2
    _ = n * n^3 - 2 * n^2 - 3 * n^3 + 3*n^3 := by ring
    _ ≥ 10 * n^3 - 2 * n^2 - 3 * n^3 + 3*n^3 := by rel[hn]
    _ = 7 * n * n^2 - 2 * n^2 + 3 * n^3 := by ring
    _ ≥ 7 * 10 * n^2 - 2 * n^2 + 3 * n^3 := by rel[hn]
    _ = 68 * n^2 + 3 * n^3 := by ring
    _ > 3 * n^3 := by extra
